<template>
  <div id="">
    <!--头部-->
    <mt-header title="Imitation qq list">
    ...
    <div class="wrapper">
      <div  v-for="item in list" key='i.id' class="item">
        <v-touch
          ...
          <span class="item-text">description：{{item.description}}</span>
...
const list = [
  {name: 'Project 1', description: 'This is a project that introduced vue-touch'},
  {name: 'Project 2', description: 'This is a project that introduced vue-touch'},
  {name: 'Project 3', description: 'This is a project that introduced vue-touch'}
]
export default {
  name: '',
  data: () => ({
