<template>
  ...
  <mt-header title="Popup">
    ...
    <div class="page-popup-wrapper">
      <mt-button @click.native="popupVisible1 = true" size="large" ref="button">Middle popup popup</mt-button>
      <mt-button @click.native="popupVisible2 = true" size="large">Pop up on the side</mt-button>
      <mt-button @click.native="popupVisible3 = true" size="large">The right popup popup</mt-button>
      <mt-button @click.native="popupVisible4 = true" size="large">Pop-up popup below</mt-button>
    </div>
    <mt-popup v-model="popupVisible1" popup-transition="popup-fade" class="mint-popup-1" :style="{ top: buttonBottom + 10 + 'px' }">
      <h1>popup</h1>
      <p>/ ˈpɑpˌʌp /</p>
      <p>n. Pop-up; [stick] infield ball; automatic take-off device</p>
      <p>It has an automatic take-off device</p>
    </mt-popup>
    ...
    <mt-popup v-model="popupVisible3" position="right" class="mint-popup-3" :modal="false">
      <mt-button @click.native="popupVisible3 = false" size="large" type="primary">Close popup</mt-button>
    </mt-popup>
